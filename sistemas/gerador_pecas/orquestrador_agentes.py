...
3. Agente 3 (Gerador): Gera a peça jurídica usando Gemini 3.7 Flash
"""
...
MODELO_AGENTE2_PADRAO = "gemini-3.7-flash"
MODELO_AGENTE3_PADRAO = "gemini-3.7-flash"
...
class OrquestradorAgentes:
    ...
    async def processar_processo(
        ...
        try:
            ...
            # ========================================
            # AGENTE 3: Gerador de Peça (Gemini 3.7 Flash)
            # ========================================
            print("\n" + "=" * 60)
            print("[AGENTE 3] GERADOR (Gemini 3.7 Flash)")
            print("=" * 60)
    ...
    async def _executar_agente3(
        ...
        """
        Executa o Agente 3 - Gerador de Peça (Gemini 3.7 Flash)
